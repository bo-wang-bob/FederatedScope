...
def main():
    ...
    for config_set in config_sets:
        ...
        for path in configs:
            ...
            ours = content.setdefault("ggeur", {})
            ours["task_adaptation_file"] = args.task_file
            ours["task_class_counts"] = []
            ours["task_default_target_size"] = ""
            ours["training_distribution_dir"] = args.distribution_dir
            ours["reuse_augmented_feature_cache"] = False
            path.write_text(
                yaml.safe_dump(
