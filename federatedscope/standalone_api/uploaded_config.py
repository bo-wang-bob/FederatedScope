...
class UploadedConfig:
    ...
    def normalize(self, payload):
        ...
        validated = self.base.normalize({**req, 'group': 'officehome_vit', 'clientCount': 4, 'sampleClients': 0})
    ...
    def catalog(self):
        ...
        for value in self.store.list():
            ...
            catalog['groups'].append(dict(id=group, dataset=value['name'], backbone='vit', domains=1,
