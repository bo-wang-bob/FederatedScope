...
const defaults: RequestConfig = {
  group: 'military_vit', method: 'heterogeneous_solution', name: '',
  rounds: 30, clientCount: 15, sampleClients: 0, batchSize: 32, localEpochs: 1,
...
export const designCatalog: Catalog = {
  ...
  groups: [{
    id: defaults.group, dataset: 'MilitaryAircraft-3D', backbone: 'vit', domains: 3,
